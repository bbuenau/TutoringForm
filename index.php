		 ...
		 <div class="width">
		  ...
		  <div class="width">
			<fieldset>
				...
				<input type="checkbox" name="time[]" value="Other"> Other <br><br>
				...
				<input type="checkbox" name="tlength[]" value="Other"> Other <br>
			</fieldset>
		  </div>
			<br>
		  <div class="width">
			<fieldset>
				...
				<input type="checkbox" name="tutortype[]" value="Other"> Other <br><br>
				...
				If you answered yes to paying for a tutor, how much are you willing/able to pay? (This may affect what kind of tutor you are able to get.)<br>
				...
				<input type="checkbox" name="amount[]" value="Other"> Other<br><br>	
			</fieldset>
		  </div>
		  <br>
